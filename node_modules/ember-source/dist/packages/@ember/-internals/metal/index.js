...
import { combine, CURRENT_TAG, validateTag, valueForTag, CONSTANT_TAG, dirtyTagFor, setAutotrackingTransactionEnv, setPropertyDidChange, tagFor, ALLOW_CYCLES, createUpdatableTag, updateTag, consumeTag, deprecateMutationsInAutotrackingTransaction, isTracking, track, untrack, trackedData } from '@glimmer/validator';
...
function get(obj, keyName) {
  ...
  if (isObjectLike && isTracking()) {
    consumeTag(tagForProperty(obj, keyName)); // Add the tag of the returned value if it is an array, since arrays
